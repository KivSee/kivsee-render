#ifndef __EFFECT_TIMED_HUE_H__
#define __EFFECT_TIMED_HUE_H__
...
namespace kivsee_render
{
    namespace effect
    {
        ...
        class TimedHue : public Effect
        {
        public:

            static bool InitFromPb(pb_istream_t *stream, const pb_field_t *field, void **arg);

            TimedHue(float_functions::IFloatFunction *offset_factor): offset_factor(offset_factor) {}
