#ifndef __EFFECT_TIMED_BRIGHTNESS_H__
#define __EFFECT_TIMED_BRIGHTNESS_H__
...
namespace kivsee_render
{
    namespace effect
    {
        ...
        class TimedBrightness : public Effect
        {
        public:

            static bool InitFromPb(pb_istream_t *stream, const pb_field_t *field, void **arg);

            TimedBrightness(float_functions::IFloatFunction *mult_factor_increase, float_functions::IFloatFunction *mult_factor_decrease): mult_factor_increase(mult_factor_increase), mult_factor_decrease(mult_factor_decrease) {}
...
#endif // __EFFECT_TIMED_BRIGHTNESS_H__
