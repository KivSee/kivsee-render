#ifndef __EFFECT_POSITION_SATURATION_H__
#define __EFFECT_POSITION_SATURATION_H__
...
namespace kivsee_render
{
    namespace effect
    {
        ...
        class PositionSaturation : public Effect
        {
        public:

            static bool InitFromPb(pb_istream_t *stream, const pb_field_t *field, void **arg);

            PositionSaturation(float_functions::IFloatFunction *mult_factor_increase, float_functions::IFloatFunction *mult_factor_decrease): mult_factor_increase(mult_factor_increase), mult_factor_decrease(mult_factor_decrease) {}
...
#endif // __EFFECT_POSITION_SATURATION_H__
