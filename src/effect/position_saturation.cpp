...
namespace kivsee_render
{
    namespace effect
    {
        void PositionSaturation::Render(float rel_time, int cycle_index)
        {
        ...
        bool PositionSaturation::InitFromPb(pb_istream_t *stream, const pb_field_t *field, void **arg)
        {
            kivsee_proto_render_v1_PositionSaturationEffectConfig config = kivsee_proto_render_v1_PositionSaturationEffectConfig_init_zero;
            ...
            if (!pb_decode(stream, kivsee_proto_render_v1_PositionSaturationEffectConfig_fields, &config))
            {
                return false;
            }
            ...
            *((Effect **)*arg) = new PositionSaturation(mult_factor_increase, mult_factor_decrease);
            return true;
        }
